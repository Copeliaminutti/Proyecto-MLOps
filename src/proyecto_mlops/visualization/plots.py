...
def main(args: Optional[Any] = None) -> None:
    ...
    # Guardar el reporte en artifacts/eval/metrics.json (path relativo, salida esperada por DVC)
    eval_metrics_path = Path("artifacts/eval/metrics.json")
    ...
    print(f"\nReporte guardado en: {eval_metrics_path}")
